...
import static com.tbk.exercise.utils.ConstantUtil.AUTHORITIES;
import static com.tbk.exercise.utils.ConstantUtil.USERNAME_MAIL;
...
public class JwtProvider {
	...
	@Value("${tbk.exercise.secretSeed}")
	private String secret;

	@Value("${tbk.exercise.mls}")
